...
<main class="px-auto w-full m-0 p-0 w-140">
    ...
    <p class="ml-20 lg:ml-32 xl:ml-32 text-5xl lg:text-2xl xl:text-2xl text-gray-500 pt-10 sm:font-thin md:font-thin lg:font-normal xl:font-normal">マイリスト</p>
    ...
    @if($event_num == 0)
        ...
        <div class="flex justify-center mt-24">
            <div class="flex flex-col">
                <p class="text-gray-400 mt-64 lg:mt-0 xl:mt-0 text-4xl lg:text-2xl xl:text-2xl flex justify-center">マイリストが空です</p>
                <p class="flex justify-center text-2xl lg:text-lg xl:text-lg mt-4 text-gray-400">タイムラインから投稿をマイリストに追加しよう</p>
            </div>
        </div>
        @else
        @endif
