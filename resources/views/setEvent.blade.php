               ...
               <div class="flex justify-center mx-64 lg:mx-64 xl:mx-96 lg:flex-row xl:flex-row flex-col">
                    <div class="flex flex-col lg:mr-10 xl:mr-10">
                              ...
                              <label class="flex flex-row mb-5 lg:justify-between xl:justify-between justify-center">
                                   ...
                                   <input required class="ml-2 border rounded-md h-10 shadow-md w-72 lg:w-44 xl:w-44 px-2 text-lg text-gray-600" type="date" name="date" value="{{ old('date') }}">
                              </label>
                              ...
                              <input maxlength="15" required class="border shadow-md rounded-md h-10 pl-2 w-72 lg:w-52 xl:w-52 text-lg" name="place" type="text" value="{{ old('place') }}">
                         </label>
                              <label class="people flex lg:justify-between xl:justify-between justify-center">
                                   ...
                                   <div class="flex flex-col pt-5">
                                        <input min="1" required class="border shadow-md rounded-md h-10 pl-2 focus:placeholder-white w-56 lg:w-44 xl:w-44 text-lg" placeholder="例) 13" name="people" type="number" value="{{ old('people') }}">
                    ...
                    <div class="mt-8 lg:mt-0 xl:mt-0 sm:w-76 md:w-76 lg:ml-10 xl:ml-10 flex justify-center">
                         ...
                         <label class="event_name flex flex-col">
                              ...
                              <textarea required name="detail" rows="8" cols="60" class="w-full border shadow-md rounded-md sm:w-80 md:w-80 lg:w-96 xl:w-96 h-44 mt-2 p-2 text-lg" placeholder="例) 服装は自由です。当日は交通機関をご利用ください。">{{ old('detail') }}</textarea>
                         </label>
                    </div>
               </div>
