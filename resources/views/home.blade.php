...
<main class="px-auto w-full m-0 p-0">
    <div class="mt-0 grid grid-cols-1 gap-10  w-full px-10 lg:px-0">
       <a href="set_event" class="btn btn-success mt-12 mx-auto rounded-3xl border border-gray-400 flex justify-around w-36 py-2 bg-white text-gray-600 hover:bg-gray-400 hover:text-white md:mr-14 mr-64 shadow-md sm:hidden">イベント作成</a>

        @foreach($events as $event)
        
        <div class="mx-auto min-w-min max-w-screen-md h-64 border border-blue-200 rounded-lg bg-white w-full">
            ...
            <div class="flex flex-row w-full">
                ...
                <div class="right-info flex flex-col"> 
                    ...
                    <div class="flex justify-center ml-20">
                        <div class="ml-32 pl-8 mt-2 mr-10 flex flex-col">
                ...
                <div class="left-info ml-auto mr-10 mt-4 flex flex-col">
                    ...
                    <!-- ボタン出し入れできるようにする -->
                    <a href="detail/{{ $event->id }}" class="bg-red-100 w-36 mt-0 p-2 rounded-xl shadow-md hover:bg-red-200"><span class="text-gray-600 text-sm flex justify-center">詳しく見る</span></a> 
                </div>
            </div>
        </div>
        @endforeach
    </div>
    <div class="ml-auto w-16 mr-32 mt-12">
        <a href="set_event" class="w-sm btn btn-success bg-gray-500 text-gray-600 lg:hidden"><img src="/images/generate.png" alt="作成" class="w-16"></a>
    </div>
</main>
@endsection
