...
<main class="px-auto w-full m-0 p-0 w-140">
    <div class="mt-0 grid grid-cols-1 gap-10  w-full px-10 sm:px-10 md:px-10 lg:px-0 xl:px-0">
       <a href="set_event" class="btn btn-success mt-12 mx-auto rounded-3xl border border-gray-400 flex justify-around w-36 py-2 bg-white text-gray-600 hover:bg-gray-400 hover:text-white md:mr-14 mr-64 shadow-md sm:hidden md:hidden lg:block  xl:block text-center">
           <span>イベント作成</span>
        </a>

        <div class="ml-auto w-16 h-16 mr-32 pt-500 border-3xl border-4 rounded-full lg:hidden xl:hidden fixed">
        ...
        <a href="detail/{{ $event->id }}" class="w-full sm:block md:block lg:hidden xl:hidden">
    ...
    <!-- <div class="ml-auto w-16 h-16 mr-32 mt-12 border-3xl border-4 rounded-full lg:hidden xl:hidden z-20 mb-100">
        <a href="set_event" class="w-sm btn btn-success lg:hidden xl:hidden z-100 ">
            <span class="material-icons ml-4 mt-4 text-blue-400 z-0">create</span>
        </a>
    </div> -->
</main>
@endsection
